...
// // 👇 Error yahan tha, maine isko strictly 'bilibili' se hata kar sirf 'string' kar diya hai
// interface HomeProps {
//   initialData: {
//     isLive: boolean;
//     title: string;
...
//   // ULTIMATE DETECTOR (Ad Blocker Logic)
//   useEffect(() => {
//     const checkForAd = () => {
//       const allElements = document.body.getElementsByTagName('*');
//       for (let i = 0; i < allElements.length; i++) {
...
//                         <BilibiliPlayer videoId={selectedVideo.videoId} title={selectedVideo.title} autoPlay={true} />
//                       ) : (
